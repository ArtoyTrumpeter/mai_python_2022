...
vlos = True
for drone, weight in zip(drone_list, drone_weight_list):
    if weight > 150 and fly_over_locality:
        print("Нужно согласовывать полёт, т. к. дрон тяжелее 150 г и пролетает над населенным пунктом")
    elif out_of_closed_area and vlos and height <= 100:
        print("Согласовывать полёт не нужно")
    else:
        print("Нужно согласовывать полёт, т. к.")
        conditions = ""
        if height > 100:
            conditions += "/высота более 100 м/"
